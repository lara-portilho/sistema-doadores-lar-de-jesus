...
import {
  ...
  RelatorioPeriodoFormValues,
} from "@forms/RelatorioPeriodoForm";
...
export const RelatorioPeriodoModal = observer(() => {
  ...
  const {
    ...
    defaultValues: relatorioPeriodoForm.defaultValues,
  });

  const validationRules = useMemo(
    () => relatorioPeriodoForm.getValidationRules(),
    [],
  );
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-between gap-10">
          ...
          <div className="flex-1">
            <TextInput
              {...register("mesInicial", validationRules.mesInicial)}
              label="Mês inicial"
              type="month"
              error={errors.mesInicial?.message}
            />
            <TextInput
              {...register("mesFinal", validationRules.mesFinal)}
              label="Mês final"
              type="month"
